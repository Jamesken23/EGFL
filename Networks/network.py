...
"""
Ref: https://github.com/Messi-Q/AMEVulDetector/blob/master/models/EncoderAttention.py
"""
class Feature_fusion_module:
    def __init__(self, opcode_data, graph_data, args, log_set):
        ...
        # ----------------------------------------We add the local graph feature------------------------------------------------------
        ...
        newgraphvec = tf.keras.layers.Attention(name='newgraphvec')([graph2vec, graphweight])
        ...
        newtransvec = tf.keras.layers.Attention(name='newtransvec')([trans2vec, transweight])
    ...
    def train(self):
        ...
        # Get the train and valid dataset
