...
from Networks.cfg_textcnn_conformer import CFG_TextCNN_Conformer
...
if __name__ == "__main__":
    ...
    is_balance = True
    args.model_name = 'CFG_TextCNN_Conformer'
    ...
    if args.model_name == 'CFG_TextCNN_Conformer':
        model = CFG_TextCNN_Transformer((X_train, X_val, Y_train, Y_val), (graph_X_train, graph_X_val, Y_train, Y_val), args, log_set)  
